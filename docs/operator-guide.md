...
2. Define consent and purpose categories for converter/facility records.
...
- safety-critical escalation path (roller entanglement, blade injury,
  crush hazard, equipment condition)
- provenance for all operating records (converter and facility both
